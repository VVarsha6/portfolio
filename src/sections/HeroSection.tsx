...
const iconClass =
    "h-4 w-4 transition-colors duration-200 text-black group-hover:text-black dark:text-white/85 dark:group-hover:text-sky-200";

const textClass =   "transition-colors duration-200 text-black/80 group-hover:text-black dark:text-white/85 dark:group-hover:text-white";
;
...
export default function HeroSection() {
  ...
  <div className="flex flex-wrap items-center justify-center gap-3">
    ...
    <NeonButton
      ...
      download
      className="
        group bg-black/[0.06] px-6 py-3
        text-sm font-semibold text-black/80
        hover:bg-black/[0.10] hover:text-black
        dark:bg-white/10 dark:text-white/85 dark:hover:bg-white/12 dark:hover:text-white
      "
    >
    ...
    <NeonButton
      ...
      title="LinkedIn"
      className="
        group bg-black/[0.05] px-4 py-3
        text-sm font-medium text-black/75
        hover:bg-black/[0.09] hover:text-black
